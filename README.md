...
there was no turning back. So I also decided to move away from Ubuntu, I use Arch BTW :stuck_out_tongue:
...
When I had no more hope searching it, I've found a good alternative (no longer working):
...
called spectrum, which can play any local song and exists an open PR to support YouTube songs.
